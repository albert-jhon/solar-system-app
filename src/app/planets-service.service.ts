...
export class PlanetsServiceService {
  private planets: Planet[] = [
    ...
    },
    {
      ...
      imageUrl: 'assets/earth_PNG15.png',
    },
    {
      name: 'Marte',
      history:
